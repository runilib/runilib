...
import { MaskedFieldBuilder, MASKS } from 'formbridge'; // new in v1.2
import { FileFieldBuilder }           from 'formbridge'; // new in v1.2
import {
  STRENGTH_CONFIG_STRICT,
  STRENGTH_CONFIG_FR,
} from 'formbridge';                                      // new in v1.2
