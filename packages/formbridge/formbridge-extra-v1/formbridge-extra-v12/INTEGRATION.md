# Integration — formbridge v1.2 features

This package adds 3 new features to your existing formbridge package.
...
```
formbridge-v12/src/fields/mask/       → formbridge/src/fields/mask/
formbridge-v12/src/fields/password/   → formbridge/src/fields/password/
formbridge-v12/src/fields/file/       → formbridge/src/fields/file/
formbridge-v12/src/components/web/WebMaskedInput.tsx   → formbridge/src/components/web/
formbridge-v12/src/components/web/WebPasswordStrength.tsx → formbridge/src/components/web/
formbridge-v12/src/components/web/WebFileField.tsx     → formbridge/src/components/web/
formbridge-v12/src/components/native/NativeMaskedInput.tsx → formbridge/src/components/native/
formbridge-v12/src/components/native/NativePasswordStrength.tsx → formbridge/src/components/native/
formbridge-v12/src/components/native/NativeFileField.tsx → formbridge/src/components/native/
formbridge-v12/__tests__/masks.test.ts     → formbridge/__tests__/
formbridge-v12/__tests__/strength.test.ts  → formbridge/__tests__/
```
...
Add to the bottom of `formbridge/src/builders/field.ts`:
...
Append to `formbridge/src/index.ts`:
...
In `package.json` of formbridge, add to `peerDependenciesMeta`:
...
import { useForm, field, MaskedFieldBuilder, FileFieldBuilder, MASKS,
         STRENGTH_CONFIG_FR } from 'formbridge';
