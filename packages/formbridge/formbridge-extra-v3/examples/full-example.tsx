/**
 * formbridge v1.3 — Draft persistence + Conditional fields
 * ──────────────────────────────────────────────────────────
 *
...
import { ConditionMixin } from 'formbridge';
import { useFormWizard }  from 'formbridge';
  ...
  const { Form, fields, state, hasDraft, clearDraft, isLoadingDraft, visibility } = useForm(
    ...
    },
    {
      ...
      persist: {
        ...
        debounce: 800,
        version:  '1',
        onRestore: (values) => console.log('[formbridge] Draft restored:', Object.keys(values)),
      },
    }
  );
