/**
 * formbridge — Dynamic / API-driven forms
 * ─────────────────────────────────────────
...
import { parseDynamicForm, parseJsonSchema, useDynamicForm } from 'formbridge';
import type { JsonFormDefinition } from 'formbridge';
...
export function JsonSchemaForm() {
  ...
  const { Form, fields } = (require('formbridge') as any).useForm(schema, { validateOn: 'onTouched' });
