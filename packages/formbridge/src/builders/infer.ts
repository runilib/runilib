...
/** Map a TypeScript value type to a formbridge field type */
...
function buildFieldFromEntry(
  ...
  // Apply overrides
  if (override.required)    (builder).required(typeof override.required === 'string' ? override.required : undefined);
