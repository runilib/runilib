    ...
    try {
      ...
      if (sourceType === 'documents' || isPdfOnly) {
        ...
        try {
          ...
          console.warn('[formbridge] expo-document-picker not installed. Run: npx expo install expo-document-picker');
          return;
        }
      } else {
        // expo-image-picker
        try {
          ...
          console.warn('[formbridge] expo-image-picker not installed. Run: npx expo install expo-image-picker');
          return;
        }
      }
