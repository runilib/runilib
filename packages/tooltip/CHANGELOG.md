...
- ✅ Initial release
- `<TooltipProvider>` — wraps the app, hosts state and the overlay
- `<Tooltip>` — registers elements as tour steps, cross-platform
- `useTooltip()` — TypeScript hook to control the tour programmatically
