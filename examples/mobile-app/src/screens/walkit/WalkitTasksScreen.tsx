...
const TASK_STEPS: { [key in string]: WalkitStepProps } = {
  SEARCH: {
    id: 'tasks-search',
    sequence: 1,
    title: '🔍 Smart search',
    content: 'Search by title, project or tag. Results update as you type.',
  },
  SORT: {
    id: 'tasks-sort',
    sequence: 2,
    title: '⇅ Sort & group',
    content: 'Sort by priority, due date, or project. Tap to cycle through options.',
  },
  ADD_FORM: {
    id: 'tasks-add-form',
    sequence: 3,
    title: '✍️ Quick add',
    content: 'Type a task title here and hit Enter. Priority and due date are optional.',
  },
  LIST: {
    id: 'tasks-list',
    sequence: 4,
    title: '📋 Full task list',
    content: 'All your tasks across projects. Tap any card to open its details.',
  },
};
...
const ALL_TASKS = [
  {
    id: 1,
    title: 'Integrate @runilib/react-walkit in mobile',
    priority: 'High',
    due: 'Today',
    project: 'Mobile App',
    done: false,
  ...
  {
    id: 4,
    title: 'Deploy @runilib/react-walkit v1.0',
    priority: 'High',
    due: 'Done',
    project: 'Mobile App',
    done: true,
...
export function WalkitTasksScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Quick add */}
      <WalkitStep {...TASK_STEPS.ADD_FORM}>
        <View style={s.addRow}>
          <TextInput
            style={s.addInput}
            ...
            >
              ...
              <View
                style={[
                  s.priorityTag,
                  {
                    borderColor: `${PCOLOR[task.priority]}40`,
                    backgroundColor: `${PCOLOR[task.priority]}18`,
                  },
                ]}
              >
                <Text style={[s.priorityTagText, { color: PCOLOR[task.priority] }]}>
                  {task.priority}
                </Text>
              </View>
            </TouchableOpacity>
