...
import { CustomerCheckoutExample } from '../src/components/formbridge-examples/CustomerCheckoutExample';
import { CustomMaskExamplesShowcase } from '../src/components/formbridge-examples/CustomMaskExamplesShowcase';
import { FieldVariantsShowcase } from '../src/components/formbridge-examples/FieldVariantsShowcase';
import { ResolverExamplesShowcase } from '../src/components/formbridge-examples/ResolverExamplesShowcase';
import { StylingExamplesShowcase } from '../src/components/formbridge-examples/StylingExamplesShowcase';
...
export default function HomeScreen() {
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      >
        {/* ── Header ── */}
        <WalkitStep {...HOME_STEPS.GREETING}>
          <View style={s.header}>
            <View>
        ...
        {/* ── Filter bar ── */}
        <WalkitStep {...HOME_STEPS.FILTER_BAR}>
        ...
        <View style={s.sectionHeader}>
          ...
          <WalkitStep {...HOME_STEPS.ADD_TASK}>
            <TouchableOpacity
              style={s.addBtn}
      ...
      <WalkitStep {...HOME_STEPS.BOTTOM_NAV}>
        <View style={s.bottomNav}>
          {[
            { icon: '⊞', label: 'Dashboard', idx: 0, route: '/' },
            { icon: '◻', label: 'Tasks', idx: 1, route: '/tasks' },
            { icon: '◷', label: 'Calendar', idx: 2, route: undefined },
            { icon: '◯', label: 'Profile', idx: 3, route: '/profile' },
          ].map((tab) => (
            <TouchableOpacity
              key={tab.idx}
              style={s.tabItem}
