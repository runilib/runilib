...
import {
  ...
  formatDemoJson,
  simulateSubmitDelay,
} from '../../src/components/formbridge-examples/shared';
...
export default function CrossPageWizardScreen() {
  ...
  useEffect(() => {
    ...
    if (routeStepId !== wizard.currentStepId) {
      router.replace(`/wizard/${wizard.currentStepId}`);
    }
