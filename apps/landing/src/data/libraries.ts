...
export const LIBRARIES: LibraryInfo[] = [
  {
    ...
    desc: 'Guide users with animated spotlight tours. Same API on React web and React Native, with customizable popovers, theming, and programmatic control.',
    color: 'amber',
    icon: '💬',
    version: '1.0.0',
  ...
  },
  {
    ...
    highlights: [
      ...
      'useFormWizardBridge() for multi-step flows',
