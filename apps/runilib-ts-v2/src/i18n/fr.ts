...
export const fr: Translations = {
  ...
  hero: {
    ...
    subtitle:    'RUNILIB est un écosystème de librairies cross-platform pour React et React Native. formbridge, stepwise, tooltip — et bien d\'autres à venir.',
  ...
  features: {
    ...
    items: [
      { title: 'Schema-first',      desc: 'Décris ton intention en TypeScript. La librairie génère les composants, la validation et l\'UI automatiquement.' },
      { title: 'Cross-platform',    desc: 'Un seul schema fonctionne sur React (web) et React Native. Pas de code dupliqué, pas de divergence.' },
      { title: '100% TypeScript',   desc: 'Types inférés automatiquement depuis ton schema. Zéro casting, zéro any, autocomplétion complète.' },
      { title: 'Accessible par défaut', desc: 'WCAG 2.1 AA out of the box. Navigation clavier, ARIA roles, focus management — tout est géré.' },
      { title: 'Zéro config',       desc: 'Pas de provider obligatoire, pas de configuration initiale. import + use. C\'est tout.' },
      { title: 'Composable',        desc: 'Chaque librairie fonctionne seule ou ensemble. L\'écosystème grandit sans casser l\'existant.' },
    ],
  },
  libs: {
    label:    'Écosystème',
    title:    '3 librairies, 1 philosophie',
  ...
  ecosystem: {
    ...
    subtitle: 'RUNILIB n\'est pas une librairie. C\'est une façon de développer — sans duplication, sans friction, sans compromis entre web et mobile.',
    principles: {
      label: 'Principes',
