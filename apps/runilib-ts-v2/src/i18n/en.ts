...
export const en: Translations = {
  ...
  hero: {
    ...
    subtitle:    'RUNILIB is a cross-platform library ecosystem for React and React Native. formbridge, stepwise, tooltip — and more to come.',
    cta:         'Get started',
  ...
  features: {
    ...
    items: [
      { title: 'Schema-first',      desc: 'Describe your intent in TypeScript. The library generates components, validation and UI automatically.' },
      { title: 'Cross-platform',    desc: 'One schema works on both React (web) and React Native. No duplicated code, no divergence.' },
      { title: '100% TypeScript',   desc: 'Types inferred automatically from your schema. Zero casting, zero any, full autocomplete.' },
      { title: 'Accessible by default', desc: 'WCAG 2.1 AA out of the box. Keyboard nav, ARIA roles, focus management — all handled.' },
      { title: 'Zero config',       desc: 'No mandatory provider, no initial setup. import + use. That\'s it.' },
      { title: 'Composable',        desc: 'Each library works standalone or together. The ecosystem grows without breaking existing code.' },
    ],
  },
  libs: {
    label:    'Ecosystem',
    title:    '3 libraries, 1 philosophy',
  ...
  ecosystem: {
    ...
    subtitle: 'RUNILIB is not a library. It\'s a way to develop — without duplication, without friction, without compromise between web and mobile.',
    principles: {
      label: 'Principles',
