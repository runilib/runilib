...
export const LIBRARIES: LibraryInfo[] = [
  {
    ...
    desc:      'Describe your form in TypeScript — formbridge generates the components, validation, and UI automatically, identical on React and React Native.',
    color:     'blue',
    icon:      '📋',
    version:   '1.0.0',
    ...
    install:    'npm install formbridge',
    status:     'stable',
  ...
  },
  {
    ...
    desc:      'Guide your users with interactive tours and animated spotlights — the same code on React and React Native.',
    color:     'amber',
    icon:      '🎯',
    version:   '1.0.0',
    ...
    install:    'npm install stepwise',
    status:     'stable',
    npmUrl:     'https://npmjs.com/package/stepwise',
    githubUrl:  'https://github.com/runilib/stepwise',
  },
  {
    id:        'tooltip',
    name:      'tooltip',
