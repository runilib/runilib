...
const SETUP_CODE = `# 1. Install pnpm globally if you don't have it
npm install -g pnpm
...
cd packages/formbridge && pnpm dev
cd packages/stepwise   && pnpm dev
cd packages/tooltip    && pnpm dev`
...
git checkout -b fix/stepwise-ios-scroll-crash
  ...
  return (
    <PageWrap>
        ...
        <ChecklistInner>
          ...
          <ChecklistGrid>
            {c.prChecklist.items.map((item, i) => (
              <ChecklistItem key={i}>
                <CheckBox><CheckMark>✓</CheckMark></CheckBox>
      ...
      <Section>
        ...
        <IssuesGrid>
          {c.goodFirstIssues.items.map((issue, i) => (
            <IssueCard
              key={i}
              href="https://github.com/runilib/runilib/issues"
              target="_blank"
              rel="noopener"
            >
              <IssueTop>
        ...
        <CommunityInner>
          ...
          <CommunityCards>
            {[
              ...
              <CommunityCard key={ch.name} href={ch.href} target="_blank" rel="noopener">
      ...
      <Section>
        ...
        <ContributorsWall>
          ...
          <ContribYou href="https://github.com/runilib/runilib" target="_blank" rel="noopener">
            <PulsingDot />
            You?
          </ContribYou>
        </ContributorsWall>
        ...
        <ContribNote>
          ...
          <ContribLink href="https://github.com/runilib" target="_blank" rel="noopener">
...
const IssueColor = styled.div<{ $color: string }>`
  ...
  background: ${({ theme, $color }) => {
    const map: Record<string, string> = {
      teal: theme.teal, blue: theme.blue,
      amber: theme.amber, purple: theme.purple,
      green: theme.green,
    }
