...
├── data/
│   ├── libraries.ts        ← All library metadata (formbridge, stepwise, tooltip)
│   └── docs/
│       ├── formbridge.ts   ← Complete formbridge documentation
│       ├── stepwise.ts     ← Complete stepwise documentation
│       ├── tooltip.ts      ← Complete tooltip documentation
│       └── index.ts
├── components/
...
- `/libraries/stepwise`   — stepwise docs with sidebar
- `/libraries/tooltip`    — tooltip docs with sidebar
