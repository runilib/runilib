...
// "right-start", "right-end"`,
    ...
    },
    {
      ...
      title: "Rich content",
      content:
        "Pass any ReactNode as content — text, images, buttons, or the pre-built TooltipContent.",
      code: {
...
>`,
    ...
    },
    {
      ...
      content:
        "Dim the entire screen except the target element — perfect for feature announcements.",
      code: {
