...
export const fr: Translations = {
  ...
  hero: {
    ...
    subtitle:
      "RUNILIB est un écosystème de librairies cross-platform pour React et React Native. formbridge, stepwise, tooltip — et bien d'autres à venir.",
  ...
  features: {
    ...
    subtitle: "Écrire la même logique deux fois — une pour le web, une pour mobile — c'est fini.",
    items: [
      {
        title: "Schema-first",
  ...
  libs: {
    ...
    subtitle: "Chaque librairie résout un problème différent avec la même API unifiée.",
    docs: "Documentation",
    github: "GitHub ↗",
  },
  code: {
  ...
  notFound: {
   ...
   contributing: {
    ...
    hero: {
      ...
      subtitle: 'RUNILIB est construit par la communauté, pour la communauté. Que tu corriges une faute, améliores la doc ou livres une nouvelle feature — chaque contribution compte.',
    },
    whyContribute: {
      label: 'Pourquoi contribuer',
      title: 'Ce que tu en retires',
      items: [
        { title: 'Impact réel',          desc: 'Ton code tourne en production dans des apps utilisées par de vrais développeurs chaque jour.' },
        { title: 'Portfolio open source',desc: 'Construis un portfolio visible avec des contributions significatives à un vrai écosystème.' },
        { title: 'Maîtrise TypeScript',  desc: 'Plonge dans les patterns TS avancés, les génériques et l\'architecture cross-platform.' },
        { title: 'Code reviews',         desc: 'Reçois des retours détaillés et constructifs d\'ingénieurs expérimentés.' },
        { title: 'Communauté',           desc: 'Rejoins un réseau de développeurs passionnés par la DX cross-platform.' },
        { title: 'Reconnaissance',       desc: 'Tous les contributeurs sont crédités dans les releases, le README et le site.' },
      ],
    },
    steps: {
    ...
    codeStyle: {
      ...
      rules: [
        { title: 'TypeScript strict mode',      desc: 'Tout le code doit compiler avec strict: true. Pas de any, pas de @ts-ignore sans commentaire expliquant pourquoi.' },
        { title: 'Pas de fichiers CSS',         desc: 'Le style passe exclusivement par styled-components. Pas d\'objets style inline sauf pour les valeurs vraiment dynamiques (positions, pourcentages issus du state).' },
        { title: 'Props transientes',           desc: 'Utilise des props préfixées $ dans styled-components pour éviter leur transmission au DOM — ex: $active, $color, $open.' },
        { title: 'Exports nommés',              desc: 'Toujours utiliser des exports nommés. Pas de default export sauf pour les pages et la racine App.' },
        { title: 'Cross-platform en premier',   desc: 'Chaque field, composant et hook doit fonctionner sur React ET React Native. Teste les deux. Le code platform-spécifique va dans /web ou /native.' },
        { title: 'Tests obligatoires',          desc: 'Les nouvelles features nécessitent des tests. Les correctifs nécessitent un test de régression. Lance npm test avant de pousser.' },
        { title: 'Conventional commits',        desc: 'Suis Conventional Commits : feat:, fix:, docs:, refactor:, test:, chore:. Cela alimente le générateur de changelog.' },
        { title: 'Pas d\'effets de bord à l\'import', desc: 'Les entry points de librairie doivent être purs. setLocale() et autres configurateurs sont des appels explicites — jamais automatiques à l\'import.' },
      ],
    },
    prChecklist: {
    ...
    goodFirstIssues: {
      ...
      items: [
        ...
        { tag: 'docs',             title: 'Ajouter des exemples formbridge dans les docs',  desc: 'Ajouter 3 exemples de formulaires réels : paiement, édition profil, enquête multi-étapes.', color: 'purple' },
      ],
    },
    community: {
      label:    'Communauté',
      title:    'Rester connecté',
      subtitle: 'Pose des questions, partage des idées, rencontre d\'autres contributeurs.',
    },
    recognition: {
      label:    'Reconnaissance',
      title:    'Mur des contributeurs',
      subtitle: 'Chaque contribution mergée mérite une place ici. Code, docs, design, traductions, signalements de bugs — tout compte.',
    },
    cta: {
